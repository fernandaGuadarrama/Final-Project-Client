  ...
  return (<div className="card-group">
          <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title">Amazing house in Morelos</h5>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">incredible house in Pedregal</h5>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">House in closed community in Santa Fé</h5>
              <p className="card-text">
